            ...
            <div className="max-w-[1240px] mx-auto px-4 relative">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-[25px] md:text-[32px] font-regular">
                        ...
                        <span className="text-[#FF5349]">Properties</span>
                    </h2>
                </div>
                ...
                >
                    <SwiperSlide className="!w-auto">
                        <button className="bg-[#FF5349] text-white px-5 py-2 rounded-lg text-sm font-medium whitespace-nowrap">
                            All Properties
                        </button>
                    </SwiperSlide>
                    ...
                    {[
                        ...
                        <SwiperSlide key={index} className="!w-auto">
                            <button className="bg-gray-100 text-gray-700 px-5 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition whitespace-nowrap">
                                {location}
                            </button>
                        </SwiperSlide>
                    ))}
